                ...
                <div className="container">
                    <div className="box">
                        <div className="breadcumb">
                            ...
                            <span><i className='bx bxs-chevrons-right'></i></span>
                            <Link to={'./Detail'}>{data[0]?.name}</Link>
                        </div>
                    </div>
                    <div className="row product-row">
                        <div className="col-5 col-md-12">
                            <div className="product-img" id="product-img">
                                <img src={data[0]?.link1} alt="" />
                            </div>
                            <div className="box">
                        ...
                        <div className="col-7 col-md-12">
                            <div className="product-info">
                                ...
                                <div className="product-info-detail">
                                    <span className="product-info-detail-title">Brand:{data[0]?.brand}</span>
                                    <a href="#">JBL</a>
                                </div>
                                <div className="product-info-detail">
                                    <span className="product-info-detail-title">Rated:{data[0]?.rated}</span>
                                ...
                                <div className="product-info-price">{data[0]?.newPrice}</div>
                                <div className="product-quantity-wrapper">
                                    <span className="product-quantity-btn">
                                        <i className='bx bx-minus'></i>
                                    </span>
                                    <span className="product-quantity">{data[0]?.quantity}</span>
                                    <span className="product-quantity-btn">
